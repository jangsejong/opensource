...
'''
It's may caused by the different versions of cv2. 
The version of cv2 module with CUDA support will give you a 2-D array 
when calling network.getUnconnectedOutLayers(). 
